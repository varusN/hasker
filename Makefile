prod:
	...
	@docker run -d --restart on-failure --net hasker --ip 10.88.64.5 -p 8000:8000 -v /var/log/hasker/:/var/log/hasker/ -v /home/hasker/media/:/home/hasker/hasker/media/ -v /home/hasker/hasker/conf/usgi:/home/hasker/conf/usgi  --name hasker_backend hasker_image
	@sleep 2
	@echo 'whait a minute...'
